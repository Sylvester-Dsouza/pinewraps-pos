...
export const apiMethods = {
  ...
  pos: {
    ...
    getOrders: async (params?: { status?: string, startDate?: string, endDate?: string, paymentStatus?: string, pickupDate?: string, deliveryDate?: string, page?: number, limit?: number | string, search?: string, searchType?: string }) => {
      try {
